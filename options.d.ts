...
declare type KeyOptionsForLocale<GKey extends string, Locale extends ObjectPatternForConcatedKey<GKey>> = TranslationValueByKey<GKey, Locale> extends string ? RawKeyOptions<GKey, Locale> : // @ts-ignore
